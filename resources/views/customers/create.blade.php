                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="/customers" method="POST">
                        ...
                        <fieldset>
                            ...
                            <!-- Firstname input-->
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="name"> {{ __('customers.first_name') }} </label>
                                <div class="col-md-9 {{ $errors->first('first_name') ? 'form-group has-error' : ''}}">
                                    <input id="first_name" name="first_name" type="text" placeholder="" class="form-control" value="{{ old('first_name') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 {{ $errors->first('last_name') ? 'form-group has-error' : ''}}">
                                    <input id="last_name" name="last_name" type="text" placeholder="" class="form-control" value="{{ old('last_name') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 {{ $errors->first('email') ? 'form-group has-error' : ''}}">
                                    <input type="email" id="email" name="email" class="form-control email" placeholder="" value="{{ old('email') }}">
                                    @error('email')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 {{ $errors->first('gender') ? 'form-group has-error' : ''}}">
                                    <input type="text" id="gender" name="gender" class="form-control" placeholder="" value="{{ old('gender') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 {{ $errors->first('ip_address') ? 'form-group has-error' : ''}}">
                                    <input type="text" id="ip_address" name="ip_address" class="form-control" placeholder="" value="{{ old('ip_address') }}">
                                    @error('ip_address')
                                    <div class="alert alert-danger"> {{ __($message) }} </div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 {{ $errors->first('company') ? 'form-group has-error' : ''}}">
                                    <input type="text" id="company" name="company" class="form-control" placeholder="" value="{{ old('company') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 {{ $errors->first('city') ? 'form-group has-error' : ''}}">
                                    <input type="text" id="city" name="city" class="form-control" placeholder="" value="{{ old('city') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 {{ $errors->first('website') ? 'form-group has-error' : ''}}">
                                    <input type="text" id="website" name="website" class="form-control" placeholder="" value="{{ old('website') }}">
                                    @error('website')
                                    <div class="alert alert-danger"> {{ __($message) }} </div>
                                    @enderror
                                </div>
